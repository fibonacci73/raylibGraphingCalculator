...
## Installation
You can download the [game.exe](game.exe) file if you only want to run the program.  
To edit the source code, download everything from the `master` branch and edit the [Makefile](Makefile) by inserting your raylib installation path (e.g.  
